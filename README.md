...
The script plugin is a powerful tool with which scripts can be executed directly or using hooks on the SCM-Manager instance. Scripts with Groovy syntax are supported.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-script-plugin/docs).
